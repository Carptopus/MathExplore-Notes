...
| --- | --- | --- | --- | --- |
| [Affine stabilizers of two o-monomial value sets](research/o-monomial-affine-stabilizers/README.md)<br>[PDF](research/o-monomial-affine-stabilizers/o-monomial-affine-stabilizers.pdf) · [BibTeX](research/o-monomial-affine-stabilizers/CITATION.bib) | Finite geometry, finite fields, o-monomials, hyperovals, affine stabilizers | Proves trivial affine stabilizers for the $\overline{\mathrm{Segre}}$ and Glynn I value sets for every odd $m\ge5$, completing the two families left untreated among all currently known nontranslation o-monomials | v0.1-beta | Internally verified public Beta; external review pending |
