...
| [Exact certificates for the first two cases not covered by Steinberger's cyclotomic minimum-degree theorem](research/cyclotomic-minimum-degree-first-two-cases/README.md)<br>[PDF](research/cyclotomic-minimum-degree-first-two-cases/cyclotomic-minimum-degree-first-two-cases.pdf) · [BibTeX](research/cyclotomic-minimum-degree-first-two-cases/CITATION.bib) | Cyclotomic polynomials, nonnegative coefficients, CRT tensor arrays, exact certificates | Proves the conjectured minimum degree and unique monic minimizer for the first two parameters outside Steinberger's general theorem | v0.1-beta | Internally verified candidate proof; external review pending |
