...
| --- | --- | --- | --- | --- |
| [Positive Jacobi realizations for complete-bipartite symmetric edge polytopes](research/positive-jacobi-complete-bipartite-sep/README.md)<br>[PDF](research/positive-jacobi-complete-bipartite-sep/positive-jacobi-complete-bipartite-sep.pdf) · [BibTeX](research/positive-jacobi-complete-bipartite-sep/CITATION.bib) | Ehrhart theory, symmetric edge polytopes, Jacobi matrices | Proves the canonical-line property for K(4,n) and K(5,n) by positive Jacobi realizations, and positivity of the first two inverse tail coefficients for all 3 <= m <= n; does not settle the full conjecture | v0.1-beta | Internally reviewed preprint; external review pending |
