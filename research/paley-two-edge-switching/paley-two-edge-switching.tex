...
Whether individual arrays from the present family also admit alternative
compatible Youden representations is a separate representation problem and
is not used in the proof.

\section{Reproducibility}
The proof is independent of computation.  The accompanying repository
contains five complementary verification paths:
\begin{itemize}
