...
\begin{center}
\small\itshape
Public Beta v0.2. The theorem chain has passed an internal writing-admission audit,
...
\item An ILAS 2026 abstract by Vander Meulen, reporting joint work with Cavers and Li [6], announces a
   characterization of sign patterns that require or allow the nSSP.  No public theorem or proof was
   found as of 22 August 2026, so the abstract may overlap or supersede the pattern-level classification
   here but cannot presently be compared theorem by theorem.  This is an explicit priority risk.
\end{enumerate}
...
The later root-loop spider and rooted-tree manuscripts [7, 8] strictly extend the fixed-matrix
spectral-separation mechanism from two arms to branching trees.  They do not reprove the present
allow/not-allow classification for arbitrary loop sets, whose pattern-level quantifiers remain distinct.
...
The released verification-code snapshot is anchored by Git commit
\texttt{1eac397bc5db\allowbreak ac2107dcb1ed\allowbreak 95ea8a96b232\allowbreak fa65}; the entry manifest records
the file hashes used by this version.
...
\bibitem{ref6} K. N. Vander Meulen,
   \emph{Sign patterns that require or allow the non-symmetric strong spectral property},
   abstract, 27th Conference of the International Linear Algebra Society (2026),
   joint work with M. Cavers and Z. Li,
   \url{https://ilas2026.math.vt.edu/docs/ILAS2026-Book-Of-Abstracts.pdf}.
\bibitem{ref7} Carptopus,
   ...
   \url{https://doi.org/10.5281/zenodo.22045527}.
\bibitem{ref8} Carptopus,
   \emph{A recursive non-symmetric strong spectral criterion for root-loop tree matrices},
   MathExplore Notes, Public Beta v0.2 (2026),
   \url{https://doi.org/10.5281/zenodo.22045531}.
\end{thebibliography}
